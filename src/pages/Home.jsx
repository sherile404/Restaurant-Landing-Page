...
function Home() {
  return (
    <div className="bg-slate-100 bg-[url('/home-background.png')] bg-right bg-contain bg-no-repeat">
      <div className="flex items-center justify-center min-h-screen px-8 pt-8 mx-auto max-w-6xl">
        <div className="w-1/2">
          ...
          <br />
          <button className="flex items-center justify-center bg-[#FE9E0D] text-white rounded-full py-2 px-4 gap-2">
